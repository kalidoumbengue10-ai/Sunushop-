...
export function MerchantDeliverySettings({ merchantId, categories, zones }: { merchantId: string; categories: Array<{ id: string; name: string }>; zones: MerchantDeliveryZone[] }) {
