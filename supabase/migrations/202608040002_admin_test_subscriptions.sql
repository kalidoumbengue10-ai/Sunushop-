-- Activation temporaire depuis le CRM pour tester le parcours marchand sans paiement réel.
create function public.admin_activate_test_subscription(
  p_merchant_id uuid,
  p_plan_id text default 'essential',
...
begin
  ...
  insert into public.audit_events (
    ...
    auth.uid(),
    p_merchant_id,
    'subscription.test_activate',
    'merchant_subscription',
    v_subscription.id::text,
    jsonb_build_object('plan_id', p_plan_id, 'days', p_days)
  );
