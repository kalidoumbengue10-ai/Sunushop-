...
-- create_order_batch : ajoute la branche retrait en boutique (chantier 4.2).
-- Un groupe avec methodKind = 'pickup' n'a besoin d'aucun deliveryZoneId ;
-- le frais de livraison est forcé à 0 en base, jamais lu depuis le client.
